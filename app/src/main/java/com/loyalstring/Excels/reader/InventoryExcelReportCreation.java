...
public class InventoryExcelReportCreation extends AsyncTask<Void, Integer, String> {
    ...
    public InventoryExcelReportCreation(List<Itemmodel> toplist, List<Itemmodel> bottomlist, String topfile, String bottomfile, FragmentActivity context, String frag, String type, HashMap<String, ArrayList<Itemmodel>> excelmap, InventoryBottomAdaptor inventoryBottomAdaptor) {
